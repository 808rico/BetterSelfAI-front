...
const UpgradePopup = ({ onClose }) => {
  const [selectedPlan, setSelectedPlan] = useState('yearly'); // Set yearly plan as default

  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white w-11/12 md:w-1/3 p-6 rounded-lg shadow-lg relative">
        {/* Close Button */}
        <button onClick={onClose} className="bg-transparent absolute top-3 right-3 text-gray-600 hover:text-gray-800">
        ...
        <div className="space-y-4">
          {/* Yearly Plan with Save 30% label */}
          <div
